...
const Contactus = () => {
  ...
  const handlesubmit = () => {
    window.open(`mailto:namkiin@gmail.com?subject=Sample&body=${body}`);
  };
  return (
        ...
        <div className="showAdrss">
          <div className="box">
            ...
            <div className="adressCtn">
              <h3> Address</h3>
              <p>Ghulam Ishaq Khan Institute, Topi, Swabi</p>
            </div>
          </div>
          <div className="box">
            <div className="iconCtn">
            ...
            <div className="adressCtn">
              <h3>Lets Talk</h3>
              <p className="infoCtn">09007601</p>
            </div>
          </div>
          <div className="box">
            <div className="iconCtn">
            ...
            <div className="adressCtn">
              <h3>Sale Support</h3>
              <p className="infoCtn">namkiinStore@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
